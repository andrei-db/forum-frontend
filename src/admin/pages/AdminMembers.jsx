    ...
    return (
        <div className="min-h-screen bg-neutral-950 text-neutral-300 p-6">
            ...
            <div className="bg-neutral-800 rounded-lg overflow-hidden border border-neutral-800 shadow">
                ...
                <div className="grid grid-cols-[80px_1.5fr_2fr_1fr_1.5fr] bg-neutral-800 text-sm font-bold text-neutral-400">
                    <div></div>
                ...
                {members.map((member) => (
                    <div
                        key={member.id}
                        className="grid grid-cols-[80px_1.5fr_2fr_1fr_1.5fr] 
